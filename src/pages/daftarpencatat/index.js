...
export default function RegistrasiPencatat() {
  ...
  const validate = () => {
    ...
    if (!form.cabang) {
      newErrors.cabang = "Alamat/Cabang Perusahaan Wajib Diisi";
    }
    if (!form.email_pemilik) {
      newErrors.email_pemilik = "Alamat/Cabang Perusahaan Wajib Diisi";
    }
        ...
        <Container maxWidth="sm">
          <Paper className={classes.paper}>
            <Typography variant="h5" component="h1" className={classes.title}>
              Buat Akun Baru bagian Pencatatan
            </Typography>
            <form onSubmit={handleSubmit} noValidate>
              ...
              <TextField
                ...
                // menampilkan pesan error dari console sebagai text field
                error={error.nama_perusahaan ? true : false}
                helperText={error.nama_perusahaan}
                // diambil dari setsubmitting
                disabled={isSubmitting}
              />
              <TextField
                id="cabang"
                name="cabang"
                label="Alamat/Cabang Perusahaan"
                margin="normal"
                fullWidth
                required
                variant="outlined"
                value={form.cabang}
                onChange={handleChange("cabang")}
                // menampilkan pesan error dari console sebagai text field
                error={error.cabang ? true : false}
                helperText={error.cabang}
                // diambil dari setsubmitting
                disabled={isSubmitting}
              />
              ...
              <TextField
                ...
                onChange={handleChange("email_pemilik")}
                // menampilkan pesan error dari console sebagai text field
                error={error.email_pemilik ? true : false}
                helperText={error.email_pemilik}
                // diambil dari setsubmitting
                disabled={isSubmitting}
              />
